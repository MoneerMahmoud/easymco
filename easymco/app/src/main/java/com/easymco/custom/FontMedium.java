...
public class FontMedium  extends AppCompatTextView {
    public FontMedium(Context context) {
        super(context);
        fontCustom();
    }
    ...
    public void fontCustom(){
        Typeface font = Typeface.createFromAsset(getContext().getAssets(), "fonts/RobotoMedium.ttf");
