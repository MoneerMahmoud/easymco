...
public class DataBaseLanguageDetails extends SQLiteOpenHelper {

    final static String name = "db_language_details";
    ...
    private static DataBaseLanguageDetails sInstance;

    public static synchronized DataBaseLanguageDetails getInstance(Context context) {
        if (sInstance == null) {
            sInstance = new DataBaseLanguageDetails(context.getApplicationContext());
        }
        return sInstance;
    }

    private DataBaseLanguageDetails(Context context) {
